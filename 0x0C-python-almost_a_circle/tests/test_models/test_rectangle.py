...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_zero(self):
        ...
        r.update()
        self.assertEqual("[Rectangle] (4) 4/4 - 4/4", str(r))

    def test_update_args_one(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898)
        self.assertEqual("[Rectangle] (898) 4/4 - 4/4", str(r))

    def test_update_args_two(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898, 2)
        self.assertEqual("[Rectangle] (898) 4/4 - 2/4", str(r))

    def test_update_args_three(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898, 2, 3)
        self.assertEqual("[Rectangle] (898) 4/4 - 2/3", str(r))
    ...
    def test_update_args_five(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898, 2, 3, 4, 5)
        self.assertEqual("[Rectangle] (898) 4/5 - 2/3", str(r))

    def test_update_args_more_than_five(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898, 2, 3, 4, 5, 6)
        self.assertEqual("[Rectangle] (898) 4/5 - 2/3", str(r))
    ...
    def test_update_args_twice(self):
        r = Rectangle(4, 4, 4, 4, 4)
        r.update(898, 2, 3, 4, 5, 6)
        r.update(6, 5, 4, 3, 2, 898)
        self.assertEqual("[Rectangle] (6) 3/2 - 5/4", str(r))

    def test_update_args_invalid_width_type(self):
        r = Rectangle(4, 4, 4, 4, 4)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(898, "invalid")

    def test_update_args_width_zero(self):
        r = Rectangle(98, 98, 98, 98, 98)
    ...
    def test_update_args_invalid_y(self):
        ...
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            r.update(898, 2, 3, 98, "invalid")

    def test_update_args_y_negative(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            r.update(898, 1, 2, 3, -6)

    def test_update_args_width_before_height(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(898, "invalid", "invalid")

    def test_update_args_width_before_x(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(898, "invalid", 1, "invalid")

    def test_update_args_width_before_y(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(898, "invalid", 1, 2, "invalid")

    def test_update_args_height_before_x(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            r.update(898, 1, "invalid", "invalid")

    def test_update_args_height_before_y(self):
        r = Rectangle(98, 98, 98, 98, 98)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            r.update(898, 1, "invalid", 1, "invalid")
